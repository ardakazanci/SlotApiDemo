package com.ardakazanci.slotapidemo
...
import com.ardakazanci.slotapidemo.ui.theme.SlotApiDemoTheme
...
fun MainScreen() {
    ...
    ScreenContent(
        ...
        titleContent = {
            if (imageSelected) {
                TitleImage(drawing = R.drawable.ic_android_black_24dp)
            } else {
                Text(
                    text = "Downloading",
...
private fun DemoPreview() {
    SlotApiDemoTheme {
        CheckBoxes(linearSelected = true, imageSelected = true, onTitleClick = { /*TODO*/ }) {
            { /*TODO*/ }
        }
    }
}
